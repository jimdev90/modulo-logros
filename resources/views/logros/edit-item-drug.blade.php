                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <div class="col-6">
                                            <form method="post" action="{{ route('edit-item-drug.put', ['data'  => $data->id]) }}">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group">
                                                    <label for="">Tipo</label>
                                                    <input type="text" class="form-control" value="{{ $data->type_drug->name }}" readonly>
                                                </div>
                                                ...
                                                <div class="form-group mt-2">
                                                    ...
                                                    <input name="ton" type="text" class="form-control" value="{{ $data->ton }}">
                                                </div>
                                                <div class="form-group mt-2">
                                                    <label for="">Kilogramos</label>
                                                    <input name="kilogram" type="text" class="form-control" value="{{ $data->kilogram }}">
                                                </div>
                                                <div class="form-group mt-2">
                                                    <label for="">Gramos</label>
                                                    <input name="gram" type="text" class="form-control" value="{{ $data->gram }}">
                                                </div>
                                                <div class="form-group mt-2">
