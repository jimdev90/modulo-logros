                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <div class="col-6">
                                            <form method="post" action="{{ route('edit-item-fuel.put', ['data'  => $data->id]) }}">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group">
                                                    <label for="">Tipo</label>
                                                    <input type="text" class="form-control" value="{{ $data->type_fuel->name }}" readonly>
                                                </div>
